...
public class ShootingAppActivity
    ...
    private void initSensors()
        ...
        if( acclSensor == null ) {
            ...
            throw new Exception( "Oops, there is no magnetic sensor on this device :(" );
        }
    ...
    private void detectShootingDirectionAndRegion( SensorEvent event ) {
        ...
        if(mGravity != null && mMagnetic != null) {
            shootingDirection =  getDirection();
            shootingRegion = getRegion(shootingDirection);
        }
    ...
    /* Accelerometer and Magnetic Vector Sensor */
